          ...
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-4 py-3 font-medium text-sm transition-colors border-b-2 -mb-px ${isActive
        ...
        {isLoading ? (
          ...
          <div className="space-y-4">
            {bookings.map((booking: any) => (
              <div
                key={booking.id}
                className="border border-gray-200 rounded-sm p-6 hover:shadow-md transition-shadow cursor-pointer"
                onClick={() =>
