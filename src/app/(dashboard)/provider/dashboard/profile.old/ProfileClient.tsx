    ...
    <>
      <div className="min-h-screen  py-6 sm:py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          {/* PERSONAL INFO CARD */}
          <Card className="shadow-md rounded-sm border-gray-200 hover:shadow-lg transition-shadow mb-6">
            ...
            <CardContent className="p-4 sm:p-6">
              {user?.addresses && user.addresses.length > 0 && (
                <div className="space-y-4">
                  <div className="p-4 sm:p-6 rounded-sm border-2 border-border hover:border-border/80 transition-all bg-gradient-to-br from-muted/50 to-card">
                    {/* Address Details */}
                    <div className="space-y-3">
                      ...
                      <div className="mt-3 pt-3 border-t border-border bg-card rounded-sm p-3">
