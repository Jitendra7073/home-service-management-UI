      ...
      <div className="w-full max-w-7xl px-4 py-8 space-y-6">
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-start gap-6">
              {/* Avatar Skeleton */}
              <div className="w-24 h-24 bg-gray-200 rounded-sm animate-pulse flex-shrink-0" />
                ...
                <div className="flex items-start justify-between">
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      <div className="h-6 bg-gray-200 rounded-sm w-28 animate-pulse" />
                      <div className="h-6 bg-gray-200 rounded-sm w-20 animate-pulse" />
                    </div>
                  </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[1, 2].map((i) => (
                <div key={i} className="border border-gray-200 rounded-sm p-4 space-y-2">
                  <div className="h-5 bg-gray-200 rounded w-40 animate-pulse" />
                  <div className="h-4 bg-gray-200 rounded w-28 animate-pulse" />
                  <div className="h-6 bg-gray-200 rounded-sm w-16 animate-pulse" />
                </div>
              ))}
            </div>
          </CardContent>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[1, 2].map((i) => (
            <div key={i} className="h-20 bg-gray-200 rounded-sm animate-pulse" />
          ))}
        </div>
      </div>
    </div>
