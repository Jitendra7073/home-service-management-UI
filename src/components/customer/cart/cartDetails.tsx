            ...
            <div className="lg:col-span-2 space-y-6">
                  ...
                  {steps.map((step, index) => (
                    <React.Fragment key={step.id}>
                      <div className="flex flex-col items-center flex-1">
                        <div
                          className={`w-12 h-12 rounded-sm flex items-center justify-center ${currentStep > step.id
                      ...
                      {index < steps.length - 1 && (
                        <div
                          className={`h-1 flex-1 mx-2 rounded ${currentStep > step.id
                              ? "bg-green-500"
                              : "bg-gray-200"
                            }`}
                        />
              ...
              <div className="bg-white rounded-sm shadow-sm p-6">
                ...
                {slotTimeWarning.show && (
                  <div className="mb-6 p-4 bg-red-50 border-l-4 border-red-500 rounded-sm flex gap-3">
                ...
                <div className="flex gap-4 mt-6">
                  {currentStep === 2 && (
                    <button
                      ...
                      className="flex-1 py-3 px-6 rounded-sm border-2 border-gray-300 text-gray-700 font-semibold hover:bg-gray-50">
                      Back
                    </button>
                  )}
                  ...
                  {currentStep === 1 && (
                    <button
                      ...
                      disabled={!canProceed()}
                      className={`flex-1 py-3 px-6 rounded-sm font-semibold flex items-center justify-center gap-2 ${canProceed()
