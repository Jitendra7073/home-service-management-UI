...
export default function CancellationStatusAlert({
    ...
    if (compact) {
        return (
            <div className={`flex items-center gap-2 px-3 py-2 rounded-sm ${statusConfig.bgColor} ${statusConfig.borderColor} border`}>
    ...
    return (
        <div className={`p-3 rounded-sm ${statusConfig.bgColor} ${statusConfig.borderColor} border`}>
